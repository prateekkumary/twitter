    ...
    return (
        <div>
            ...
            <div className='flex space-x-5'>
                <Avatar onClick={() => naviagate(`/profile/${6}`)} alt="username" src="https://pbs.twimg.com/profile_images/1476982902701244417/GiwXfZy5_400x400.jpg" className='cursor-pointer' />
                <div className='w-full'>
                    ...
                    <div className='mt-2'>
                        <div className='cursor-pointer'>
                            <p className='mb-2 p-0'> This is nice projrct. this is springboot full stack prject</p>
                            <img className='w-[28rem] border border-gray-400 p-5 rounded-md' src="https://pbs.twimg.com/profile_images/1476982902701244417/GiwXfZy5_400x400.jpg" alt="" />
